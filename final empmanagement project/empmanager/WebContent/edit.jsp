...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
           ...
           <h3>Edit the employee record for Employee ID:</h3>
           </br>
           
   <%
   String action = request.getParameter("action");
   String empIdAsString = request.getParameter("empid");
   
   EmployeeDAO dao = new EmployeeDAO();
   
   Employee emp = dao.getEmployeeById(Integer.parseInt(empIdAsString));
 ...
 <form name="updateForm" action="EditServlet"  method="post">
<div class="col-lg-5">
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">EmpId&nbsp&nbsp&nbsp</span>
  <input type="text" class="form-control" value="<%=emp.getEmpId() %>" name="empid" readonly aria-describedby="sizing-addon1">
</div></br>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Name&nbsp&nbsp&nbsp&nbsp</span>
  <input type="text" class="form-control" value="<%=emp.getEmpName() %>" name="name"  aria-describedby="sizing-addon1">
</div></br>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Salary&nbsp&nbsp&nbsp&nbsp&nbsp</span>
  <input type="text" class="form-control" value="<%=emp.getSalary() %>" name="salary"   aria-describedby="sizing-addon1">
</div></br>
<div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Department</span>
  <input type="text" class="form-control" value="<%=emp.getDept() %>" name="dept"  aria-describedby="sizing-addon1">
</div></br>
